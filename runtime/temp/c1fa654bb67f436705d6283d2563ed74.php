<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"D:\Aliases\lianmeng/app/admin\view\index\iframe.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <ul class="layui-nav fr nobg head-info" lay-filter="">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    ...
                    <dd><a href="<?php echo url('admin/user/iframe?val=0'); ?>" class="j-ajax" refresh="yes">默认布局</a></dd>
                ...
                <li class="layui-nav-item <?php if($kk == 1): ?>layui-nav-itemed<?php endif; ?>">
                    ...
                    <dl class="layui-nav-child">
                        <?php if($vv['title'] == '快捷菜单'): ?>
                            <dd><a class="admin-nav-item" data-id="0" href="<?php echo url('admin/index/welcome'); ?>"><i class="aicon ai-shouye"></i> 后台首页</a></dd>
                            ...
                            <dd><a class="admin-nav-item" data-id="<?php echo $vvv['id']; ?>" href="<?php echo url($vvv['url'].'?'.$vvv['param']); ?>"><i class="<?php echo $vvv['icon']; ?>"></i> <?php echo $vvv['title']; ?></a><i data-href="<?php echo url('menu/del?ids='.$vvv['id']); ?>" class="layui-icon j-del-menu">&#xe640;</i></dd>
                            ...
                            <dd><a class="admin-nav-item" data-id="<?php echo $vvv['id']; ?>" href="<?php if(strpos('http', $vvv['url']) === false): ?><?php echo url($vvv['url'].'?'.$vvv['param']); else: ?><?php echo $vvv['url']; endif; ?>"><i class="<?php echo $vvv['icon']; ?>"></i> <?php echo $vvv['title']; ?></a></dd>
        ...
        var tab = {
                add: function(title, url, id) {
                    element.tabAdd('hisiTab', {
                        title: '<i class="layui-icon j-ajax" data-href="<?php echo url('admin/menu/quick'); ?>?id='+id+'">&#xe600;&nbsp;</i>'+title,
