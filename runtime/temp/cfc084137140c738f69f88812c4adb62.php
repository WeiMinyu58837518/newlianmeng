<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:52:"D:\Aliases\lianmeng/app/total\view\goodstype\add.php";i:1516001258;s:45:"D:\Aliases\lianmeng\app\total\view\layout.php";i:1515746580;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515659782;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="pid" class="field-role_id" type="select">
                ...
                <option value="<?php echo $vo['id']; ?>"><?php echo $vo['level']; ?><?php echo $vo['type']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="type" lay-verify="title" autocomplete="off" placeholder="请输入分类名称">
        </div>
    </div>
    <div class="layui-form-item">
