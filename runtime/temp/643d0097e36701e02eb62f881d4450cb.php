<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:48:"D:\Aliases\lianmeng/app/total\view\shop\edit.php";i:1516007898;s:45:"D:\Aliases\lianmeng\app\total\view\layout.php";i:1515746580;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515659782;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="type_id" class="field-role_id" type="select">
                ...
                <option value="<?php echo $ty['id']; ?>" <?php echo $data['type_id']==$ty['id']?"selected=''" : ''; ?>><?php echo $ty['level']; ?><?php echo $ty['type']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="name" value="<?php echo $data['name']; ?>" lay-verify="title" autocomplete="off" placeholder="请输入商品名称">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="price" value="<?php echo $data['price']; ?>" lay-verify="title" autocomplete="off" placeholder="请输入商品价格">
        </div>
    </div>
    <!--图片-->
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="sex" class="field-role_id" type="select">
                <option value="1" <?php echo $data['sex']==1?"selected" : ''; ?>>公</option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="age" value="<?php echo $data['age']; ?>" lay-verify="title" autocomplete="off" placeholder="请输入年龄">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">颜色</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-email" name="color" value="<?php echo $data['color']; ?>" lay-verify="title" autocomplete="off" placeholder="请输入颜色">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">简介</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-email" name="intro" value="<?php echo $data['intro']; ?>" lay-verify="title" autocomplete="off" placeholder="请输入简介">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea id="UEditor2" name="details"><?php echo $data['details']; ?></textarea>
    </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
