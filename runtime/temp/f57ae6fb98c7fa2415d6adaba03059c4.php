<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:49:"D:\Aliases\lianmeng/app/total\view\shop\index.php";i:1516009691;s:45:"D:\Aliases\lianmeng\app\total\view\layout.php";i:1515746580;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515659782;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tbody>
            <?php if(is_array($merchant) || $merchant instanceof \think\Collection || $merchant instanceof \think\Paginator): $ke = 0; $__LIST__ = $merchant;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($ke % 2 );++$ke;?>
            <tr>
                <td><?php echo $ke; ?></td>
                <td><a href="<?php echo url("/total/shop/goods/id/".$vo['id']); ?>"><?php echo $vo['name']; ?></a></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
