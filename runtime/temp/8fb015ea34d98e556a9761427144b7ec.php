<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:54:"D:\Aliases\lianmeng/app/total\view\goodstype\index.php";i:1516009048;s:45:"D:\Aliases\lianmeng\app\total\view\layout.php";i:1515746580;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515659782;}*/ ?>
    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td><?php echo $vo['level']; ?><?php echo $vo['type']; ?></td>
                <td><?php echo $vo['pid']; ?></td>
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a href="<?php echo url('edit?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon"></i></a>
                            <a href="javascript:void(0)" class="layui-btn layui-btn-primary layui-btn-small delete" idd="<?php echo $vo['id']; ?>"><i class="layui-icon"></i></a>
                        </div>
                    </div>
                </td>
            </tr>
...
<script>
    $('.delete').click(function(){
        if(confirm('确定删除？')){
            ...
            $.post('<?php echo url("/total/goodstype/delete"); ?>',data,function(a){
                if(a.info==10000){
                    layer.msg('删除成功');
                    location.reload();
                }
