<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:49:"D:\Aliases\lianmeng/app/total\view\shop\myadd.php";i:1516012156;s:45:"D:\Aliases\lianmeng\app\total\view\layout.php";i:1515746580;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515659782;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="name" value="" lay-verify="title" autocomplete="off" placeholder="请输入商品名称">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="price" value="" lay-verify="title" autocomplete="off" placeholder="请输入商品价格">
        </div>
    </div>
    <!--图片-->
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="age" value="" lay-verify="title" autocomplete="off" placeholder="请输入年龄">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">颜色</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-email" name="color" value="" lay-verify="title" autocomplete="off" placeholder="请输入颜色">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">简介</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-email" name="intro" value="" lay-verify="title" autocomplete="off" placeholder="请输入简介">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">简介</label>
        <div class="layui-input-block">
            <textarea id="UEditor2" name="details"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
