<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:47:"D:\Aliases\lianmeng/app/total\view\type\add.php";i:1515469316;s:45:"D:\Aliases\lianmeng\app\total\view\layout.php";i:1515746580;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515659782;}*/ ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="pid" class="field-role_id" type="select">
                ...
                <?php if(is_array($type) || $type instanceof \think\Collection || $type instanceof \think\Paginator): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?>
                <option value="<?php echo $vol['id']; ?>"><?php echo $vol['level']; ?><?php echo $vol['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
