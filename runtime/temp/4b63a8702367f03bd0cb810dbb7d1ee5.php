<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"D:\Aliases\lianmeng/app/total\view\shop\mygoods.php";i:1516013051;s:45:"D:\Aliases\lianmeng\app\total\view\layout.php";i:1515746580;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515659782;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="page-toolbar">
        <div class="layui-btn-group fl">
            ...
            <a href="<?php echo url('myadd'); ?>" class="layui-btn layui-btn-primary"><i class="aicon ai-tianjia"></i>添加</a>
                ...
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            ...
                            <a href="javascript:vold(0);" class="layui-btn layui-btn-primary layui-btn-small delete" idd="<?php echo $vo['id']; ?>"><i class="layui-icon"></i></a>
                        </div>
                    </div>
                </td>
            </tr>
...
<script>
    $('.delete').click(function(){
        if(confirm('确定删除')){
            ...
            $.post('<?php echo url("/total/shop/delete"); ?>',data,function(a){
                if(a.info==10000){
                    layer.msg('删除成功');
                    location.reload();
                }
