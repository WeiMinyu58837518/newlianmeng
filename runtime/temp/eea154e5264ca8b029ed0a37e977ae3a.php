<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:49:"D:\Aliases\lianmeng/app/total\view\type\index.php";i:1516009067;s:45:"D:\Aliases\lianmeng\app\total\view\layout.php";i:1515746580;s:51:"D:\Aliases\lianmeng\app\admin\view\block\header.php";i:1515659782;s:50:"D:\Aliases\lianmeng\app\admin\view\block\layui.php";i:1515659782;s:51:"D:\Aliases\lianmeng\app\admin\view\block\footer.php";i:1515659782;}*/ ?>
    ...
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                ...
                <td><?php echo $vo['level']; ?><?php echo $vo['name']; ?></td>
                <td><?php echo $vo['pid']; ?></td>
<!--                <td>-->
<!---->
<!--                    <input type="checkbox" name="status" <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('status?table=type&ids='.$vo['id']); ?>">-->
<!--                </td>-->
                <td>
