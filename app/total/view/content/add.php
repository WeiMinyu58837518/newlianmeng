<form class="layui-form layui-form-pane" action="{:url('add')}" id="editForm" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="title" lay-verify="title" autocomplete="off" placeholder="请输入标题内容">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" class="layui-input field-username" name="author" lay-verify="title" autocomplete="off" placeholder="请输入作者名称">
        </div>
        <div class="layui-form-mid layui-word-aux"></div>
    </div>
    <!--图片-->
